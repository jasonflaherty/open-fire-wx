...
const en = {
  ...
  'fire.refreshingUpdates': 'Refreshing fire details…',
  ...
  'fire.refresh': 'Refresh fire details',
  'fire.close': 'Close',
  'fire.unnamed': 'Fire',
...
const es: Record<MessageKey, string> = {
  ...
  'fire.refreshingUpdates': 'Actualizando detalles del incendio…',
  ...
  'fire.refresh': 'Actualizar detalles del incendio',
  'fire.close': 'Cerrar',
